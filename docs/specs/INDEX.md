...
| ROUND | Review round identity | Durable review-round records: input and review-context bindings, canonical fingerprints, finding instances, structured coverage, and interrupted-round reconciliation | round, fingerprint, finding instance, coverage state, audit identity | `crates/porch-gate/src/`, `crates/porch-run/src/`, `crates/porch-review/src/` | `./2026-08-30-review-round-identity/` | In-progress | ROAD-6 | — |
