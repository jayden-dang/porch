...
This directory is the product briefing. Treat these files as the current spec until a decision in `decisions.md` is superseded in writing. Implementation is through **M16** (porch-owned review-quality engine; last milestone). Workflow freeze remains M15; coding-agent review stays available. OCR wrapper is optional/legacy. See [09-roadmap.md](09-roadmap.md), [11-review-quality-brief.md](11-review-quality-brief.md), and D9/D13/D15. Operator loop: [10-operator-checklist.md](10-operator-checklist.md).
